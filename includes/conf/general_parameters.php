...
$system_title   = "FUNDACITE | OPSU"; //titulo del sistema ::: TEC
...
$redir          = 'http://localhost/fundacite-opsu/index.php';
$ruta_base      = '//localhost/fundacite-opsu/';
// Configuracion de Modulos Activos en en Sistema (0:Inactivo, 1:Activo)
$mod_moodle  = 0;
//Mod Chat
global $absolute_uri;
$absolute_uri   = 'http://localhost/fundacite-opsu/';
$mod_chat       = 1;
// Mensajes de error.
