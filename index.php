    ...
    <div class="wrapper-page">
        <div class="panel panel-color panel-primary panel-pages">
            <div class="panel-body">
                ...
                <h3 class="text-center m-t-0 m-b-15"> <a href="index.php" class="logo logo-admin"><span>OPSU</span></a></h3>
                <?php
               ...
               <!-- fin notificacion de error -->
                        <div id="login-form" class="content-box bg-default">
                            <div class="content-box-wrapper pad20A">
                                ...
                                <div class="row">
                                    <div class="text-right col-md-12"> <a href="#" data-toggle="modal" data-target="#myModal" class="switch-button" switch-target="#login-forgot" switch-parent="#login-form" title="Recover password">¿Aún no estas registrado? <br>Registrate aquí</a> </div>
                                </div>
                            </div>
                        </div>
            </form>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Registrate</h4> </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" for="solicitud_Monto">NIT</label>
                            <div id="Info"></div>
                            <div class="col-sm-8">
