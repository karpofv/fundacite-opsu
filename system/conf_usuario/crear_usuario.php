...
if ($editar=='1' and $codigo==""){
    ...
    if ($consulu>0){
        ...
        paraTodos::arrayInserte("Cedula, Usuario, Nivel, contrasena", "usuarios", "$cedula, '$usuario', '$tipo', '$pass'");
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <table class="table table-hover" id="usuarios">
                                    ...
                                    <tbody>
                                        <?php
                                        $consulsol = paraTodos::arrayConsulta("u.id,u.Cedula,concat(r.Nombres,' ',r.Apellidos) as nombre, u.Usuario, p.Nombre", "usuarios u, registrados r, perfiles p", "u.Cedula=r.cedula and u.Nivel=p.CodPerfil and (u.Nivel=1 or u.Nivel=4)");
