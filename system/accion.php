...
if($_SESSION['usuario_perfil']==1){
    ...
    ?>
  <script type="text/javascript">
    var cargando = '<center><img style="width:40px;" src="<?php echo $ruta_base;?>assets/images/loader.gif" border="0"> Esto tomará algunos minutos</center>';
      $("#ultnotify").html("<?php echo $notificacion;?>");
      $("#notify").removeClass("green");
      $("#notify").removeClass("transparent");
      $("#notify").addClass("<?php echo $colorback;?>");
  </script>
