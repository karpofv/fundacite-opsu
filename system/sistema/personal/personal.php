...
<?php
	...
	if ($editar=='1' and $nombre!="" and $codigo==""){
		...
		if ($consul>0){
			...
			paraTodos::arrayInserte("per_cedula, per_nombres, per_apellidos, per_telefono    , per_correo", "personal", "$cedula, '$nombre', '$apellido', '$telefono', '$correo'");
		}
	}
	/*UPDATE*/
	if($editar == 1 and $nombre !="" and $codigo!=""){
		paraTodos::arrayUpdate("per_cedula=$cedula, per_nombres='$nombre', per_apellidos='$apellido', per_telefono='$telefono', per_correo='$correo'", "personal", "per_codigo=$codigo");
	}
	/*ELIMINAR*/
	if ($eliminar !=''){
