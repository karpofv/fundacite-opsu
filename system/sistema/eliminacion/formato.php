...
$consulsol = paraTodos::arrayConsulta("r.reg_status,r.reg_codigo, p.plant_descripcion, r.reg_fecreg, r.reg_fechaexp, r.reg_cedula, r.reg_nombres, r.reg_apellidos, r.reg_correo, r.reg_telefono, r.reg_recepcedula, r.reg_recpnombre, r.reg_recepapellido, e.est_descripcion, s.st_descripcion", "rsni r, plantel p, tools_estados e , tools_status s", "r.reg_plancodigo=p.plant_codigo and r.reg_recepestado=e.est_codigo and reg_caso='ELIMINACION' and s.st_codigo=r.reg_status and reg_codigo=$_GET[cod]");
foreach($consulsol as $row){
    ...
    $pdf->Cell(10,10,utf8_decode(""),0,0,'J');
    $pdf->Cell(10,10,utf8_decode(""),1,1,'C');
	$pdf->SetFont('Arial','',12);    
