...
if ($editar=='1' and $cedula!="" and $codigo==""){
    $consul = paraTodos::arrayConsultanum("reg_cedula", "rsni", "reg_cedula=$cedula and reg_caso='DESBLOQUEO' and reg_status='1'");
    if ($consul>0){
        paraTodos::showMsg("Este estudiante ya posee un caso de desbloqueo activo", "alert-danger");
    } else{
        $fecha = paraTodos::deconvertDate($fecha);
        paraTodos::arrayInserte("reg_plancodigo,reg_fecreg, reg_cedula, reg_nombres, reg_apellidos, reg_caso, reg_correo, reg_telefono, reg_fechaexp, reg_recpnombre, reg_recepapellido, reg_recepcedula, reg_recepestado, reg_status", "rsni", "'$plantcodigo',current_date, '$cedula', '$nombre', '$apellido', 'DESBLOQUEO','$correo', '$telefono', '$fecha', '$nomrecep', '$aperecep', '$cedrecp','$estadorecep', '1'");
    }
}
/*UPDATE*/
if($editar == 1 and $cedula !="" and $codigo!=""){
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <table class="table table-hover" id="plantel">
                                        ...
                                        <tbody>
                                            <?php
                                            $consulsol = paraTodos::arrayConsulta("*", "rsni , tools_status", "reg_plancodigo=$plantcodigo and reg_status=st_codigo and reg_caso='DESBLOQUEO'");
